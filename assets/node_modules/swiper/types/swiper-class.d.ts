...
import type { CSSSelector, SwiperModule } from 'swiper/types/shared.d.ts';
import type { SwiperEvents } from 'swiper/types/swiper-events.d.ts';

import type { A11yMethods } from 'swiper/types/modules/a11y.d.ts';
import type { AutoplayMethods } from 'swiper/types/modules/autoplay.d.ts';
import type { ControllerMethods } from 'swiper/types/modules/controller.d.ts';
import type { CoverflowEffectMethods } from 'swiper/types/modules/effect-coverflow.d.ts';
import type { CubeEffectMethods } from 'swiper/types/modules/effect-cube.d.ts';
import type { FadeEffectMethods } from 'swiper/types/modules/effect-fade.d.ts';
import type { FlipEffectMethods } from 'swiper/types/modules/effect-flip.d.ts';
import type { CreativeEffectMethods } from 'swiper/types/modules/effect-creative.d.ts';
import type { CardsEffectMethods } from 'swiper/types/modules/effect-cards.d.ts';
import type { HashNavigationMethods } from 'swiper/types/modules/hash-navigation.d.ts';
import type { HistoryMethods } from 'swiper/types/modules/history.d.ts';
import type { KeyboardMethods } from 'swiper/types/modules/keyboard.d.ts';
import type { MousewheelMethods } from 'swiper/types/modules/mousewheel.d.ts';
import type { NavigationMethods } from 'swiper/types/modules/navigation.d.ts';
import type { PaginationMethods } from 'swiper/types/modules/pagination.d.ts';
import type { ParallaxMethods } from 'swiper/types/modules/parallax.d.ts';
import type { ScrollbarMethods } from 'swiper/types/modules/scrollbar.d.ts';
import type { ThumbsMethods } from 'swiper/types/modules/thumbs.d.ts';
import type { VirtualMethods } from 'swiper/types/modules/virtual.d.ts';
import type { ZoomMethods } from 'swiper/types/modules/zoom.d.ts';
import type { FreeModeMethods } from 'swiper/types/modules/free-mode.d.ts';
import type { ManipulationMethods } from 'swiper/types/modules/manipulation.d.ts';
