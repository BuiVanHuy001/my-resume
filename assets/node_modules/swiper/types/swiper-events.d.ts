...
import type { A11yEvents } from 'swiper/types/modules/a11y.d.ts';
import type { AutoplayEvents } from 'swiper/types/modules/autoplay.d.ts';
import type { ControllerEvents } from 'swiper/types/modules/controller.d.ts';
import type { CoverflowEffectEvents } from 'swiper/types/modules/effect-coverflow.d.ts';
import type { CubeEffectEvents } from 'swiper/types/modules/effect-cube.d.ts';
import type { FadeEffectEvents } from 'swiper/types/modules/effect-fade.d.ts';
import type { FlipEffectEvents } from 'swiper/types/modules/effect-flip.d.ts';
import type { CreativeEffectEvents } from 'swiper/types/modules/effect-creative.d.ts';
import type { CardsEffectEvents } from 'swiper/types/modules/effect-cards.d.ts';
import type { HashNavigationEvents } from 'swiper/types/modules/hash-navigation.d.ts';
import type { HistoryEvents } from 'swiper/types/modules/history.d.ts';
import type { KeyboardEvents } from 'swiper/types/modules/keyboard.d.ts';
import type { MousewheelEvents } from 'swiper/types/modules/mousewheel.d.ts';
import type { NavigationEvents } from 'swiper/types/modules/navigation.d.ts';
import type { PaginationEvents } from 'swiper/types/modules/pagination.d.ts';
import type { ParallaxEvents } from 'swiper/types/modules/parallax.d.ts';
import type { ScrollbarEvents } from 'swiper/types/modules/scrollbar.d.ts';
import type { ThumbsEvents } from 'swiper/types/modules/thumbs.d.ts';
import type { VirtualEvents } from 'swiper/types/modules/virtual.d.ts';
import type { ZoomEvents } from 'swiper/types/modules/zoom.d.ts';
import type { FreeModeEvents } from 'swiper/types/modules/free-mode.d.ts';
