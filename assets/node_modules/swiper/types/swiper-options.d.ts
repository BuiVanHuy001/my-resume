import type { A11yOptions } from 'swiper/types/modules/a11y.d.ts';
import type { AutoplayOptions } from 'swiper/types/modules/autoplay.d.ts';
import type { ControllerOptions } from 'swiper/types/modules/controller.d.ts';
import type { CoverflowEffectOptions } from 'swiper/types/modules/effect-coverflow.d.ts';
import type { CubeEffectOptions } from 'swiper/types/modules/effect-cube.d.ts';
import type { FadeEffectOptions } from 'swiper/types/modules/effect-fade.d.ts';
import type { FlipEffectOptions } from 'swiper/types/modules/effect-flip.d.ts';
import type { CreativeEffectOptions } from 'swiper/types/modules/effect-creative.d.ts';
import type { CardsEffectOptions } from 'swiper/types/modules/effect-cards.d.ts';
import type { HashNavigationOptions } from 'swiper/types/modules/hash-navigation.d.ts';
import type { HistoryOptions } from 'swiper/types/modules/history.d.ts';
import type { KeyboardOptions } from 'swiper/types/modules/keyboard.d.ts';
import type { MousewheelOptions } from 'swiper/types/modules/mousewheel.d.ts';
import type { NavigationOptions } from 'swiper/types/modules/navigation.d.ts';
import type { PaginationOptions } from 'swiper/types/modules/pagination.d.ts';
import type { ParallaxOptions } from 'swiper/types/modules/parallax.d.ts';
import type { ScrollbarOptions } from 'swiper/types/modules/scrollbar.d.ts';
import type { ThumbsOptions } from 'swiper/types/modules/thumbs.d.ts';
import type { VirtualOptions } from 'swiper/types/modules/virtual.d.ts';
import type { ZoomOptions } from 'swiper/types/modules/zoom.d.ts';
import type { FreeModeOptions } from 'swiper/types/modules/free-mode.d.ts';
import type { GridOptions } from 'swiper/types/modules/grid.d.ts';
